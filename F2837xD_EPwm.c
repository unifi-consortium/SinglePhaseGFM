...
//  GpioCtrlRegs.GPFPUD.bit.GPIO160 = 1;    // Disable pull-up on GPIO160 (EPWM8B)
     ...
     // Comment out other unwanted lines.
     //
    GpioCtrlRegs.GPAMUX1.bit.GPIO14 = 0;  //set it to 0 to use it as gpio // Configure GPIO14 as EPWM8A iff =1
    GpioCtrlRegs.GPAMUX1.bit.GPIO15 = 0;  //set it to 0 to use it as gpio // Configure GPIO15 as EPWM8B iff =1
